...
<% 
	...
	try {
		image.GetImage(filepath+"/images/Tumor.risk.prediction.chart/"+result_forDoctor, "ForDoctorImage", username);
	} catch (Exception e) {
		//e.printStackTrace();
	...
	try {
		 image.GetImage(filepath+"/images/Tumor.risk.prediction.chart/"+result_forPatient, "ForPatientImage", username);
	} catch (Exception e) {
		//e.printStackTrace();
