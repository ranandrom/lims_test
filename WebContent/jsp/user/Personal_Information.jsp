...
<body>
	...
	<div class="container-fluid content">
			...
			<fieldset class="col-sm-12">													
				...
				<div class="form-group">
					<div class="controls row">
						...
						<div class="input-group col-sm-12">													
							<label for="username" class="uname">公司：</label>
							<label for="username" class="uname"><%=company%></label>
						</div>	
					</div>
				...
				<div class="form-group">
					<div class="controls row">
						...
						<div class="input-group col-sm-12">													
							<label for="username" class="uname">地址：</label>
				...
				<div class="form-group">
					<div class="controls row">
						...
						<div class="input-group col-sm-12">													
							...
							<label for="username" class="uname"><%=Telephone%></label>
						</div>	
					</div>
		...
		<div>
			<button onclick="window.location.href='<%=basePath%>jsp/user/ModifyUserInformation.jsp'">修改信息</button>							
			<button onclick="window.location.href='<%=basePath%>jsp/welcome/homepage.jsp'">返回首页</button>																				
		</div>
